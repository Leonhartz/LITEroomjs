...
*  - Define angle where the object should be visible (currently only check x rotation of the camera)
*
*  Added a callback event name 'scaleValueChange' to lite.input_scalebar. It allows outside script to get the value of the scale bar.
*  USAGE: 
